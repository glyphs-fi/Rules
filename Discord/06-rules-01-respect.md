...
- Act in a kind and good-faith manner
- Do not harass, demean, bully, or degrade members either on server or in DM
- Do not insult, infantilise, or start bad-faith arguments. If it is getting heated, take a break from discord for a bit
...
- Avoid posting media with fast moving images or intense flashing lights. If you do so, spoiler and add a content warning (CW // flashing lights)
- If you believe someone to be breaking the rules, do not call it out directly, instead let staff know (see “Contacting Staff”)
- Regarding media and topic, if you have to ask if it is alright to post, it probably isn’t
